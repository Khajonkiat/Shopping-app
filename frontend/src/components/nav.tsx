...
export default function Nav({ collapsed, mobileOpen, onMobileClose }: NavProps) {
  ...
  const links = [
    { href: "/", label: t.nav.dashboard, exact: true, icon: <IconHome /> },
    { href: "/products", label: t.nav.products, exact: false, icon: <IconTag /> },
    { href: "/stores", label: t.nav.stores, exact: false, icon: <IconStore /> },
    { href: "/purchases", label: t.nav.purchases, exact: false, icon: <IconReceipt /> },
    { href: "/household", label: t.nav.household, exact: false, icon: <IconHousehold /> },
    ...(isMaster ? [{ href: "/admin/users", label: t.nav.users, exact: false, icon: <IconUsers /> }] : []),
  ];
